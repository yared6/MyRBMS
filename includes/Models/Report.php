<?php
    ...
    class SendReportHandler {
        ...
        public function sendReport(){
            $query= 'insert into '. $this->table .'(sales,juice,bread,cash) Values ('.$this->salesamount.','.$this->juiceSales.','.$this->breadsales.','.$this->cashleft.');'; 
        ...
        public function viewReport($cond=0){        
