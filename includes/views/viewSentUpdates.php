...
foreach ($viewUpdate as $value) {
    ...
    $fordelid = "../controlers/updatedeletecontroler.php?delid=$id";
    //echo "<td><button><a href=\"../controlers/deletecontroler.php?delid=$id\">Resolve</a></button></td>";
    echo "<td><input type=\"submit\" value=\"Resolve\" onclick='ajaxInsertFile(\"../controlers/updatedeletecontroler.php?delid=$id\", \"dynamic\")'></td>";
    echo "</tr>";
